<div id="edit-curfew-modal" class="modal-background-blur">
    <form action="../../Pages/Incidents/Incidents.php?filter=curfew" ; method="post" class="edit modal-content-container">
        <div onclick="closeEditCurfewModal()" class="modal-close-button">
            <ion-icon name="close"></ion-icon>
        </div>
        <div class="modal-title">
            <h3>Curfew Violation Record</h3>
            <input type="hidden" id="ID" name="recordID">
        </div>
        <div class="curfew-information">
            <p>It has been officially recorded that <span id="fullName" class="highlight-text">Christine De la
                    paz</span> broke the curfew rule on the night of <span id="date" class="highlight-text">April 2,
                    2023</span> , at exactly <span id="time" class="highlight-text">10:30 PM</span>. This means that
                he/she was out past the time that she was supposed to be home according to the rules, and his/her
                actions have been officially documented.</p>
        </div>

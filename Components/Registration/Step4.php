        ...
        <div class="limit-width">
            <label class="label-2" for="sex">Profile Picture</label>
             ...
             <div class="input-upload-container">
                <input required placeholder="Upload your Profile picture" name="profilePictureTitle" id="image-title-profile" class="input" readonly type="text"
    ...
    <div class="container">
        <div class="limit-width">
            ...
            <!-- Proof of residence upload section -->
                <input required placeholder="Upload your proof of residence" name="residenceProofTitle" id="image-title-proof" class="input" readonly type="text"
        ...
        <div class="limit-width">
            ...
            <label class="label-2" for="sex">Mobile Number (Optional)</label>
             <p class="text-medium">By providing us your mobile number, you agree to receive SMS notification and messages related from the barangay such as announcements and reminders. </p>
                <input placeholder="Input your Mobile number here" name="mobileNumber" id="image-title-proof" class="input"type="text"
                value="<?php inputContent('mobileNumber'); ?>">
        </div>
    </div>

        ...
        <div class="container">
            ...
            <div class="inputs">
                ...
                <div class="input-container">
                    ...
                    <input id="committee-input" required autocomplete="off" class="input" name="committee" type="text"
                        list="committee" placeholder="Committee">
                </div>
                <div class="input-container">
                ...
                <div class="input-container-flex-2">
                    <div class="left">
                        ...
                        <input id="start-input" required name="termstart" class="input" onfocus="(this.type = 'date')" type="text" placeholder="Start of Term">
                    </div>
                    <div class="right">
                        <label for="end-input">End of Term</label>
                        <input id="end-input" required name="termend" class="input" onfocus="(this.type = 'date')" type="text" placeholder="Expected end of Term">
                    </div>
                </div>
                <div class="input-container">

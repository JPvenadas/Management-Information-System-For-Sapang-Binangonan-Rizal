...
<div class="certificate-body">
    ...
    <p>
    This is to certify that <span><?php echo $resident['fullName']?></span>, is a legal resident of <?php echo $resident['purok']?>, Barangay Sapang Talim Island Binangonan, Rizal from the day he/she was born until present and she is known as a law abiding citizen and not connected in any subversive elements.
    </p>
    <p>

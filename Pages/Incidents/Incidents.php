...
<body>
    ...
    <main class="main-content">
        ...
        attachTabTitle("Incident Reports")?>

        <!-- Attach the filter options -->
        <?php require "../../Components/Incidents-components/Filters.php"?>

        <!-- Attach the filter options -->
        <?php require "../../Components/Incidents-components/recordList.php"?>

        <?php // floating add button
        require "../../Components/Incidents-components/floatingButton.php";

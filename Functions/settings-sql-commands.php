...
function DropTables(){
    $conn = openCon();
    $command = "DROP TABLE IF EXISTS tbl_accessControl, tbl_attendance, tbl_committee, tbl_contacts, tbl_employees, tbl_events, tbl_inventoryList, tbl_positions, tbl_purok, tbl_residents, tbl_services, tbl_transactions, tbl_userAccounts";
    mysqli_query($conn, $command);
}
